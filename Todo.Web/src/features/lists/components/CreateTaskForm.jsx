...
import { MagicCard } from '@/shared/components/magic-ui'
...
export default function CreateTaskForm({ listId, onTaskCreated }) {
  ...
  return (
    <MagicCard className="create-task-form__wrap">
      <section className="create-task-form__section" aria-labelledby="create-task-heading">
